...
setwd("H:/notebooks/vivarium_research_lsff/multiplication_models/anemia_files_u5")
getwd()
# LOAD BASELINE DATA
...
id_vars <- c("location_id", "sex_id", "age_group_id", "year_id", "vehicle","coverage_level")
